    ...
    <div className="flex justify-between">
      ...
      <nav className="hidden items-center space-x-6 text-sm font-medium sm:flex">
        ...
        <LinkWrapper
          ...
          className={cn(
            buttonVariants(),
            'flex items-center justify-center rounded-lg bg-gradient-to-r from-[#d4c4b4] to-[#f4e0c7] px-4 py-2 text-black transition-transform duration-300 ease-in-out hover:scale-110 hover:bg-gradient-to-r hover:from-[#f4e0c7] hover:to-[#d4c4b4] hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#d4c4b4] sm:w-max',
          )}
        >
        ...
        <SheetContent side="top">
          <nav className="mt-8 flex flex-col items-center space-y-6 text-sm font-medium">
            ...
            <LinkWrapper
              ...
              className={cn(
                buttonVariants(),
                'w-full rounded-full bg-gradient-to-r from-[#f4e0c7] to-[#9f6fc9] text-black hover:bg-gradient-to-r hover:from-[#f4e0c7] hover:to-[#9f6fc9] sm:w-max',
              )}
            >
              <FaDiscord className="mr-2 h-5 w-5" />
              Add Mewwme&apos;s
