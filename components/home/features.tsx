...
const features: Feature[] = [
  {
    title: 'Music Filters',
    body: 'Mewwme`s has a large collection of music filters such as 8D, Bass Boost, etc. which can be applied by a select menu!',
  ...
  {
    title: 'Customization',
    body: 'Mewwme`s is greatly customizable, which allows you to setup request channels and much more!.',
  ...
  {
    title: 'Crisp Quality',
    body: 'Have you ever dreamt of quality music without any lag issues or any downtime? Mewwme`s is what you need!.',
    icon: 'https://api.iconify.design/oi:audio.svg?color=%23f4e0c7',
  },
  {
    title: 'Buttons',
    body: 'Mewwme`s boasts an impressive feature set that includes convenient buttons located below the now playing messages.',
    icon: 'https://api.iconify.design/teenyicons:button-solid.svg?color=%23f4e0c7',
  },
  {
    title: 'Custom Playlist',
    body: 'Create your own playlist with your favorite songs and enjoy your music with Mewwme`s',
    icon: 'https://api.iconify.design/zondicons:playlist.svg?color=%23f4e0c7',
  },
  {
    title: 'Request Channel',
    body: 'Request your favorite songs to be played in a specific channel with Mewwme`s',
    icon: 'https://api.iconify.design/carbon:intent-request-inactive.svg?color=%23f4e0c7',
  },
  {
    title: 'Autoplay',
    body: "If you're busy, Mewwme`s can think and choose for you with the auto-play feature, as it is intelligent.",
    icon: 'https://api.iconify.design/pajamas:autoplay.svg?color=%23f4e0c7',
  },
  {
    title: 'Multi-Language',
    body: 'Mewwme`s is a versatile Discord bot that supports multiple languages, providing users with the ability to communicate and collaborate in their preferred language.',
    icon: 'https://api.iconify.design/lucide:languages.svg?color=%23f4e0c7',
  },
  {
    title: 'Security',
    body: "Discord music bot, Mewwme`s takes user's privacy seriously and strives to maintain the trust of its users.",
