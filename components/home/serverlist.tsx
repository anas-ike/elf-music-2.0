...
import ServerListData from '../../data/serverlist.json'
...
const ServerCard: React.FC<{ server: ServerType }> = ({ server }) => (
  <div className="server-card">
    ...
    <div className="server-details">
      ...
      <p className="text-left text-2xl text-foreground/60">
  ...
  return (
    <section className="mt-8 text-xl text-muted-foreground">
      ...
      <h3 className="text-center">
        Connecting communities and keeping users entertained every day
      </h3>
      ...
      <div className="container">
        ...
        <div className="server-slider-wrapper ml-[-30%] w-[162%]">
          ...
          >
            {ServerListData[0].map((server, index) => (
          ...
          <Marquee
            ...
            direction="right"
          >
            {ServerListData[1].map((server, index) => (
              <ServerCard key={index} server={server} />
            ))}
          </Marquee>
        </div>
