...
const faq = [
  ...
  {
    question: 'How do i add Mewwme Bots to my server?',
    answer: (
      <>
        You can add Mewwme Bots to your server by clicking{' '}
        <LinkWrapper href={links.botInvite}>here</LinkWrapper>.<br />
        <em>
          NOTE: If you want to disable <code>Administrator</code> permission
          from Mewwme, it will not work properly! You will still be able to
  ...
  {
    question: 'Why is Mewwme sometimes offline or not working?',
    answer: (
      <>
        Mewwme is developed by a single developer. So sometimes I miss
        something, and Mewwme is not working correctly. If you find any bugs,
