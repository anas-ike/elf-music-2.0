    ...
    <div className="relative">
      ...
      <div className="relative">
        ...
        <div className="mt-8 flex flex-col items-center space-y-8">
          {[
            {
              src: 'https://status-mewwme.is-a.fun/#website_monitor',
              title: 'Website Monitor',
            },
            {
              src: 'https://status-mewwme.is-a.fun/#bot_monitor',
              title: 'Last.fm Bot Monitor',
            },
            {
              src: 'https://status-mewwme.is-a.fun/#restapi_monitor',
              title: 'REST API Monitor',
            },
            {
              src: 'https://status-mewwme.is-a.fun/#lavalink_monitor',
              title: 'Lavalink Monitor',
            },
            {
              src: 'https://status-mewwme.is-a.fun/#panel_monitor',
              title: 'Panel Monitor',
            },
            {
              src: 'https://status-mewwme.is-a.fun/#server_monitor',
