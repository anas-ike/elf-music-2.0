...
export default function PremiumPage() {
  ...
  const plans = [
      ...
      tiers: [
        {
          ...
          price: '2',
          period: '/month',
          link: 'https://www.patreon.com/checkout/mewwme?rid=10067355',
          features: [
        ...
        },
        {
          ...
          price: '3.5',
          period: '/month',
          link: 'https://www.patreon.com/checkout/mewwme?rid=22189390',
          features: [
            'Refundable for 7 days',
            'Access to all Premium features',
            'Cool role in support server',
        ...
        },
        {
          ...
          price: '6',
          period: '/month',
          link: 'https://www.patreon.com/checkout/mewwme?rid=10026039',
          features: [
            'Refundable for 7 days',
            'Access to all Premium features',
            'Cool role in support server',
    ...
    },
    {
      ...
      tiers: [
        ...
        {
          name: 'Custom Bot',
          description: `Get your very own branded version of mewwme's bot`,
          price: '12',
          period: '/month',
          link: links.supportServer,
          features: [
  ...
  const data = [
    ...
    {
      criteria: 'Youtube Notify Streams',
      free: '2 streamer per server',
      premium: '30 streamer per server',
    },
    {
      criteria: 'Twitch Notify Streams',
      free: '3 streamers per server',
      premium: '50 streamers per server',
    },
  ]
        ...
        <div className="space-y-4">
          ...
          <p className="text-center text-xl text-muted-foreground">
            <Balancer>
              ...
              development & operation of Mewwme&apos;s bot.
            </Balancer>
          </p>
        </div>
