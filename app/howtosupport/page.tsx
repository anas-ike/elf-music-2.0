      ...
      <div className="relative">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            <Balancer>
              Thank you for considering supporting Mewwme! I really appreciate
              it.
            </Balancer>
          </p>
        </div>
        ...
        <div className="mt-8 flex flex-col space-y-8">
          <div>
            ...
            <p className="text-lg text-muted-foreground">
              <Balancer>
                You can support me by voting for Mewwme, inviting Mewwme to your
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground">
              <Balancer>
                ...
                to support Mewwme! <br /> Compare the features of our free and
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground">
              <Balancer>
                Purchase the Mewwme bot source code on Fiverr or BuiltByBit to
                run and customize it for your own needs.
              </Balancer>
            </p>
            <div className="mt-6 grid grid-cols-1 place-items-start gap-8 sm:grid-cols-2">
              {links.map(
                (link) =>
                  (link.label === 'Fiverr' || link.label === 'BuiltByBit') && (
                    <LinkWrapper
                      key={link.url}
                      href={link.url}
                      className="group inline-flex items-center justify-center space-x-4"
